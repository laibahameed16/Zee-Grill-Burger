     ...
     <Navbar/>
      ...
      <div className="mx-auto w-full max-w-[850px] px-5 pb-12 pt-8 sm:px-8 sm:pt-10 md:px-10 lg:px-0">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <Link href={`tel:${SITE_CONFIG.contact.phone}`} className="rounded-[18px] border border-[#eeeeee] bg-white p-5 shadow-[0_3px_15px_rgba(0,0,0,0.05)] transition-all hover:-translate-y-0.5 hover:shadow-md sm:p-6">
            ...
            <p className="mt-1 text-[11px] text-[#888] sm:text-[12px]">{SITE_CONFIG.contact.displayPhone}</p>
          </Link>

          <Link href={`mailto:${SITE_CONFIG.contact.email}`} className="rounded-[18px] border border-[#eeeeee] bg-white p-5 shadow-[0_3px_15px_rgba(0,0,0,0.05)] transition-all hover:-translate-y-0.5 hover:shadow-md sm:p-6">
            <div className="flex h-11 w-11 items-center justify-center rounded-full bg-[#fff5f1] text-[#ff542d]">
            ...
            <p className="mt-1 text-[11px] text-[#888] sm:text-[12px]">{SITE_CONFIG.contact.email}</p>
          </Link>
